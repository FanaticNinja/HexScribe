...
public class MainAnvil_v1_8_R1 implements AnvilView
{
    ...
    public MainAnvil_v1_8_R1(HexScribe plugin, Inventory anvil, Player player)
    {
        this.player = player;
        this.plugin = plugin;
        ...
        final MainAnvil_v1_8_R1 main = this;
