...
public class MainAnvil_v1_9_R2 implements AnvilView
{
    ...
    public MainAnvil_v1_9_R2(HexScribe plugin, Inventory anvil, Player player)
    {
        this.player = player;
        this.plugin = plugin;
        ...
        final MainAnvil_v1_9_R2 main = this;
    ...
    public String getNameText() {
        try {
            ...
            for (net.minecraft.server.v1_9_R2.ItemStack item : inv.getIngredientsInventory().getContents())
            {
            ...
            net.minecraft.server.v1_9_R2.ItemStack item = ((IInventory)g.get(anvil)).getItem(0);
            if (item == null)
                return null;
