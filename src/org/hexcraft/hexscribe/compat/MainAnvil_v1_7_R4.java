...
public class MainAnvil_v1_7_R4 implements AnvilView
{
    ...
    public MainAnvil_v1_7_R4(HexScribe plugin, Inventory anvil, Player player)
    {
        this.player = player;
        this.plugin = plugin;
        ...
        final MainAnvil_v1_7_R4 main = this;
